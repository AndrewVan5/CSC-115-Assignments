public class A2Tester {
	...
	public static void testIsShorterThan() {
		...
		Podcast p1 = new Podcast("Upcoming Games", hosts1, 49);
		Podcast p2 = new Podcast("The Next Big Thing", hosts2, 60);
		Podcast p3 = new Podcast("Social Media 101", hosts3, 50);
		Podcast p4 = new Podcast("Interacting with Fans: AMA", hosts4, 51);
	...
	public static void testAverageFollowers() {
		...
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(Math.abs(result-expected)<THRESHOLD, "average followers of cast in p1");
	
		result = p2.averageFollowers();
		expected = (7000000+94000000+137000000)/3.0;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(Math.abs(result-expected)<THRESHOLD, "average followers of cast in p2");

		result = p3.averageFollowers();
		expected = (136000000+9000000)/2.0;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(Math.abs(result-expected)<THRESHOLD, "average followers of cast in p3");

		result = p4.averageFollowers();
		expected = 0;
		// System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(Math.abs(result-expected)<THRESHOLD, "average followers of cast in p4");
	...
	public static void testHasHost() {
		...
		expected = true;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(result==expected, "p1 has "+in1+" as a host");

		result = p2.hasHost(in4a);
		expected = true;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(result==expected, "p2 has "+in4a+" as a host");		
		
		result = p1.hasHost(in3);
		expected = false;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(result==expected, "p1 does not have "+in3+" as a host");	
		
		result = p3.hasHost(in3);
		expected = false;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(result==expected, "p3 does not have "+in3+" as a host");

		result = p4.hasHost(in7);
		expected = true;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(result==expected, "p4 has "+in7+" as a host");
	...
	public static void testHighestFollowers() {
		...
		result = A2Exercises.highestFollowers(in3, in6);
		expected = 137000000;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(result==expected, "highest followers between "+in3+" and "+in6);

		result = A2Exercises.highestFollowers(in7, in4a);
		expected = 76500000;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(result==expected, "highest followers between "+in7+" and "+in4a);
	...
	public static void testMostFollowers() {
		...
		result = A2Exercises.mostFollowers(array4);
		expected = in6;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(result.equals(expected), "most followers in array4");
	...
	public static void testNumberShorterThan() {
		...
		Podcast p3 = new Podcast("Social Media 101", hosts3, 45);
		Podcast p4 = new Podcast("Interacting with Fans: AMA", hosts4, 120);
		Podcast p5 = new Podcast("Interacting with Fans: AMA - part 2", hosts4, 79);
		Podcast p6 = new Podcast("Interacting with Fans: AMA - part 3", hosts4, 80);

		Podcast[] array0 = new Podcast[0]; // empty array
		Podcast[] array1 = {p1};
		Podcast[] array2 = {p1, p2, p3, p4};
		Podcast[] array3 = {p1, p2, p3, p4, p5, p6};
		...
		result = A2Exercises.numberShorterThan(array3, timeLimit);
		expected = 4;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(result == expected, "array3 podcasts shorter than "+timeLimit+" minutes");
	...
	public static void testNumberWithInfluencer() {
		...
		Influencer[] hosts3 = {in2, in3};
		Influencer[] hosts4 = {in1, in5, in7};
		Influencer[] hosts5 = {in1, in5, in7, in4a, in4b};
		Influencer[] hosts6 = {in5, in7, in2, in3, in4a, in1, in4b, in6};
		
		Podcast p1 = new Podcast("Upcoming Games", hosts1, 30);
		Podcast p2 = new Podcast("The Next Big Thing", hosts2, 60);
		Podcast p3 = new Podcast("Social Media 101", hosts3, 45);
		Podcast p4 = new Podcast("Interacting with Fans: AMA", hosts4, 120);
		Podcast p5 = new Podcast("Interacting with Fans: AMA - part 2", hosts5, 130);
		Podcast p6 = new Podcast("Interacting with Fans: AMA - part 3", hosts6, 65);
		...
		result = A2Exercises.numberWithInfluencer(array3, toFind);
		expected = 4;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(result == expected, "array3 podcasts with "+toFind+" as a host");
	}
	...
	public static void testHighestAverageFollowers() {
		...
		Podcast[] array4 = {p1, p2, p3, p4, p5, p6};
		...
		result = A2Exercises.highestAverageFollowers(array4);
		expected = p2;
		//System.out.println("\nExpected: "+expected+". Result returned: "+result);
		displayResults(result.equals(expected), "highest average followers of podcast hosts in array4");
