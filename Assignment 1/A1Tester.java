...
public class A1Tester {
	...
	public static void testGreatestCommonDenominator() {
		...
		System.out.println("Testing greatestCommonDenominator(18,24)");
		result = A1Exercises.greatestCommonDenominator(18, 24);
		expected = 6;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(100,8)");
		result = A1Exercises.greatestCommonDenominator(100, 8);
		expected = 4;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(555,50)");
		result = A1Exercises.greatestCommonDenominator(555, 50);
		expected = 5;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(30,14)");
		result = A1Exercises.greatestCommonDenominator(30, 14);
		expected = 2;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(64,48)");
	...
	public static void testCountMatches() {
		...
		int[] arr2 = {-2, -5, 34, -5};
		int[] arr3 = {3, 4, 5, 3, 3, 5};
		int[] arr4 = {-2, 56, -5, 34, -5};
		int[] arr5 = {999, 5, 2, 56, -54, 9};
		int[] arr6 = {321, 345, 321, 454, 345, 321};
		...
		System.out.println("Testing countMatches(arr3, 3)");
		result = A1Exercises.countMatches(arr3, 3);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing countMatches(arr4, 35)");
		result = A1Exercises.countMatches(arr4, 35);
		expected = 0;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing countMatches(arr5, 999)");
		result = A1Exercises.countMatches(arr5, 999);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing countMatches(arr6, 321)");
		result = A1Exercises.countMatches(arr6, 321);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
