public class A4Tester {
	...
	public static void testDistanceAway() {
		...
		result = A4Exercises.distanceAway(list4, b3);
		expected = 0;
		displayResults(result==expected, "distanceAway(list4, b3)");
	}
	...
	public static void testDistanceToTallest() {
		...
		result = A4Exercises.distanceToTallest(list5);
		expected = 0;
		displayResults(result==expected, "distanceToTallest(list5)");
	...
	public static void testStackOperations() {
		...
		testStack.pop();
		result = testStack.peek();
		displayResults(result.equals(5), "peek works after initial pop");

		testStack.popAll();
		result = testStack.peek();
		displayResults(result == null, "peek works after pop all");
	...
	public static void testStackIsGeneric() {
		...
		displayResults(s1.toString().equals("{}"), "Empty Stack");
		displayResults(s2.toString().equals("{}"), "String Stack");
		displayResults(s3.toString().equals("{}"), "Double Stack");

		displayResults(s1.isEmpty(), "Empty Stack");
		displayResults(s2.isEmpty(), "String Stack");
		displayResults(s3.isEmpty(), "Double Stack");
	}
